...
// ≤‚ ‘ FOAW ¬À≤®
//#include <Filter/FOAWDifferentiator.h>
...
public:
    AC_AttitudeControl( AP_AHRS_View &ahrs,
    	...
    	/* ≤‚ ‘FOAW¬À≤®  */
    	//_foaw_roll(_dt, 0.025f), // FOWA differentiator (dt, noise amplitude)
    	//_foaw_pitch(_dt, 0.025f),
    	//_foaw_yaw(_dt, 0.025f),
        _ahrs(ahrs),
        _aparm(aparm),
        _motors(motors)
        {
...
protected:
    ...
    /* ≤‚ ‘FOAW¬À≤® */
    //FOAWDifferentiator _foaw_roll;
    //FOAWDifferentiator _foaw_pitch;
    //FOAWDifferentiator _foaw_yaw;
