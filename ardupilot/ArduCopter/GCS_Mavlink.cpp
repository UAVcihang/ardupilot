...
void NOINLINE Copter::send_rangefinder(mavlink_channel_t chan)
{
    ...
    mavlink_msg_rangefinder_send(
            chan,
            /*rangefinder.distance_cm_orient(ROTATION_PITCH_270) * 0.01f*/att.x,
            /*rangefinder.voltage_mv_orient(ROTATION_PITCH_270) * 0.001f*/att.y);
}
#endif
...
bool GCS_MAVLINK_Copter::try_send_message(enum ap_message id)
{
    ...
    case MSG_GPS_RAW:
        copter.gps.send_mavlink_gps_raw(chan);//return send_gps_raw(copter.gps);
		break;
