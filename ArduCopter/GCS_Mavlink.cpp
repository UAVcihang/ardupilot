...
/***********************************************************************************************************************
*函数原型：MAV_TYPE GCS_MAVLINK_Copter::frame_type() const
*函数功能：更新led颜色
*修改日期：2018-12-26
*修改作者：cihang_uav
*备注信息：
...
*避免对每个消息类型使用NOINLINE独立函数

*gcc中的编译器错误，会导致它使用更多的堆栈

*比需要的空间。在没有NOINLINE的情况下，我们使用
...
/***********************************************************************************************************************
*函数原型：MAV_MODE GCS_MAVLINK_Copter::base_mode() const
*函数功能：基本模式
*修改日期：2018-12-26
*修改作者：cihang_uav
*备注信息：
...
/***********************************************************************************************************************
*函数原型：uint32_t GCS_MAVLINK_Copter::custom_mode() const
*函数功能：更新led颜色
*修改日期：2018-12-26
*修改作者：cihang_uav
*备注信息：
...
/***********************************************************************************************************************
*函数原型：MAV_STATE GCS_MAVLINK_Copter::system_status() const
*函数功能：系统状态
*修改日期：2018-12-26
*修改作者：cihang_uav
*备注信息：
...
/***********************************************************************************************************************
*函数原型：NOINLINE void Copter::send_fence_status(mavlink_channel_t chan)
*函数功能：发送影响状态
*修改日期：2018-12-26
*修改作者：cihang_uav
*备注信息：
...
/***********************************************************************************************************************
*函数原型：NOINLINE void Copter::send_extended_status1(mavlink_channel_t chan)
*函数功能：发送电池电压
*修改日期：2018-12-26
*修改作者：cihang_uav
*备注信息：
...
/***********************************************************************************************************************
*函数原型：void NOINLINE Copter::send_nav_controller_output(mavlink_channel_t chan)
*函数功能：发送导航控制输出
*修改日期：2018-12-28
*修改作者：cihang_uav
*备注信息：
...
/***********************************************************************************************************************
*函数原型：int16_t GCS_MAVLINK_Copter::vfr_hud_throttle() const
*函数功能：
*修改日期：2018-12-28
*修改作者：cihang_uav
*备注信息：
...
/***********************************************************************************************************************
*函数原型：void Copter::send_pid_tuning(mavlink_channel_t chan)
*函数功能：发送PID
*修改日期：2018-12-26
*修改作者：cihang_uav
*备注信息：send PID tuning message
*************************************************************************************************************************/
...
/***********************************************************************************************************************
*函数原型：uint8_t GCS_MAVLINK_Copter::sysid_my_gcs() const
*函数功能：更新led颜色
*修改日期：2018-12-26
*修改作者：cihang_uav
*备注信息：
...
/***********************************************************************************************************************
*函数原型：uint32_t GCS_MAVLINK_Copter::telem_delay() const
*函数功能：更新led颜色
*修改日期：2018-12-26
*修改作者：cihang_uav
*备注信息：
...
/***********************************************************************************************************************
*函数原型：bool GCS_MAVLINK_Copter::handle_guided_request(AP_Mission::Mission_Command &cmd)
*函数功能：处理队列请求
*修改日期：2018-12-26
*修改作者：cihang_uav
...
/***********************************************************************************************************************
*函数原型：void GCS_MAVLINK_Copter::handle_change_alt_request(AP_Mission::Mission_Command &cmd)
*函数功能：处理高度请求
*修改日期：2018-12-28
*修改作者：cihang_uav
*备注信息：
...
/***********************************************************************************************************************
*函数原型：void GCS_MAVLINK_Copter::packetReceived(const mavlink_status_t &status,mavlink_message_t &msg)
*函数功能：包处理
*修改日期：2018-12-26
*修改作者：cihang_uav
*备注信息：
...
/***********************************************************************************************************************
*函数原型：bool GCS_MAVLINK_Copter::params_ready() const
*函数功能：参数准备
*修改日期：2018-12-26
*修改作者：cihang_uav
*备注信息：
...
/***********************************************************************************************************************
*函数原型：void GCS_MAVLINK_Copter::send_banner()
*函数功能：
*修改日期：2018-12-26
*修改作者：cihang_uav
*备注信息：
...
/***********************************************************************************************************************
*函数原型：void GCS_MAVLINK_Copter::handle_command_ack(const mavlink_message_t* msg)
*函数功能：处理应答
*修改日期：2018-12-26
*修改作者：cihang_uav
*备注信息：
...
/***********************************************************************************************************************
*函数原型：MAV_RESULT GCS_MAVLINK_Copter::_handle_command_preflight_calibration(const mavlink_command_long_t &packet)
*函数功能：处理校准命令
*修改日期：2018-12-26
*修改作者：cihang_uav
*备注信息：_scheduled_update - updates _red, _green, _blue according to notify flags
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////////////
        case MAV_CMD_DO_MOTOR_TEST:   //对电机进行测试
...
/***********************************************************************************************************************
*函数原型：AP_Mission *GCS_MAVLINK_Copter::get_mission()
*函数功能：更新led颜色
*修改日期：2018-12-26
*修改作者：cihang_uav
*备注信息：
...
/***********************************************************************************************************************
*函数原型：Compass *GCS_MAVLINK_Copter::get_compass() const
*函数功能：更新led颜色
*修改日期：2018-12-26
*修改作者：cihang_uav
*备注信息：
...
/***********************************************************************************************************************
*函数原型：AP_Camera *GCS_MAVLINK_Copter::get_camera() const
*函数功能：更新led颜色
*修改日期：2018-12-26
*修改作者：cihang_uav
*备注信息：
...
/***********************************************************************************************************************
*函数原型：AP_AdvancedFailsafe *GCS_MAVLINK_Copter::get_advanced_failsafe() const
*函数功能：更新led颜色
*修改日期：2018-12-26
*修改作者：cihang_uav
*备注信息：
...
/***********************************************************************************************************************
*函数原型：AP_VisualOdom *GCS_MAVLINK_Copter::get_visual_odom() const
*函数功能：更新led颜色
*修改日期：2018-12-26
*修改作者：cihang_uav
*备注信息：
...
/***********************************************************************************************************************
*函数原型：AP_Rally *GCS_MAVLINK_Copter::get_rally() const
*函数功能：
*修改日期：2018-12-26
*修改作者：cihang_uav
*备注信息：
