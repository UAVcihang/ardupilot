...
/****************************************************************************************************************
*函数原型：#define read_aux_switch(chan, flag, option)
*函数功能：读取外部开关设置
*修改日期：2018-7-18
*备   注：can't take reference to a bitfield member, thus a #define:
*****************************************************************************************************************/
...
/****************************************************************************************************************
*函数原型：void Copter::read_aux_switches()
*函数功能：loop函数
*修改日期：2018-7-18
*备   注：read_aux_switches - checks aux switch positions and invokes configured actions
*****************************************************************************************************************/
...
/****************************************************************************************************************
*函数原型：void Copter::compass_cal_update()
*函数功能：loop函数
*修改日期：2018-7-18
*备   注：
*****************************************************************************************************************/
...
/****************************************************************************************************************
*函数原型：void Copter::do_aux_switch_function(int8_t ch_function, uint8_t ch_flag)
*函数功能：做外部开关功能实现
*修改日期：2018-7-18
*备   注：do_aux_switch_function - implement the function invoked by the ch7 or ch8 switch
*****************************************************************************************************************/
