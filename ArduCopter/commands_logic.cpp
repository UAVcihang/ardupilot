...
void Copter::do_nav_delay(const AP_Mission::Mission_Command& cmd)
{
    ...
    if (cmd.content.nav_delay.seconds > 0) {
        ...
        nav_delay_time_max = hal.util->get_time_utc(cmd.content.nav_delay.hour_utc, cmd.content.nav_delay.min_utc, cmd.content.nav_delay.sec_utc, 0);//hal.util->get_time_utc(cmd.content.nav_delay.hour_utc, cmd.content.nav_delay.min_utc, cmd.content.nav_delay.sec_utc, 0);
    }
