...
{
	//GCS_MAVLINK::send_statustext_all(MAV_SEVERITY_WARNING, "update begin");
	//ukf.update();
}
...
void Copter::one_hz_loop()
{
	...
	//hal.console->printf("Flowermeter pwm total %d pwm_pos %.2f\n",  flowermeter.get_pwmCount(), sprayer.get_pwm_pos());
}
