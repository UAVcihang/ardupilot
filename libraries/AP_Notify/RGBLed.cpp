...
/////////////////////////////////////////////////////////////////////////////////////////////////
    // 记录用于植保的AB点信息
          if(AP_Notify::flags.ushape_record >1)//AP_Notify::flags.ushape_record=16,记录A,//AP_Notify::flags.ushape_record=81,记录B点信息
          {
          	...
          	gcs().send_text(MAV_SEVERITY_WARNING, "Record U AB point Finsh");
          	return;
          }
          ...
          if((AP_Notify::flags.ushape_record_mode)>1)
            {
                   	switch(step)  //1,2,3，4,5
                   	{
                   	  ...
                   	  gcs().send_text(MAV_SEVERITY_WARNING,"Ushape MODE RECORD"); //发送自动信息
                   	 return;
                ...
                if((AP_Notify::flags.ushape_record_mode_erro)>1)
                {
                  switch(step)  //1,2,3，4,5
                  {
                   ...
                   gcs().send_text(MAV_SEVERITY_WARNING,"Ushape MODE ERRO"); //发送自动信息
                   return;
